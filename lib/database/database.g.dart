...
class $BlocksFtsTable extends BlocksFts
    with TableInfo<$BlocksFtsTable, BlocksFt> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $BlocksFtsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'blocks_fts';
  @override
  VerificationContext validateIntegrity(
    Insertable<BlocksFt> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  BlocksFt map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return BlocksFt(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $BlocksFtsTable createAlias(String alias) {
    return $BlocksFtsTable(attachedDatabase, alias);
  }
}

class BlocksFt extends DataClass implements Insertable<BlocksFt> {
  final String id;
  final String content;
  const BlocksFt({required this.id, required this.content});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<String>(id);
  ...
  BlocksFtsCompanion toCompanion(bool nullToAbsent) {
    return BlocksFtsCompanion(id: Value(id), content: Value(content));
  }

  factory BlocksFt.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  BlocksFt copyWith({String? id, String? content}) =>
      BlocksFt(id: id ?? this.id, content: content ?? this.content);
  BlocksFt copyWithCompanion(BlocksFtsCompanion data) {
    return BlocksFt(
      id: data.id.present ? data.id.value : this.id,
      content: data.content.present ? data.content.value : this.content,
    );
...
class BlocksFtsCompanion extends UpdateCompanion<BlocksFt> {
  final Value<String> id;
  final Value<String> content;
  final Value<int> rowid;
  const BlocksFtsCompanion({
    this.id = const Value.absent(),
    this.content = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  BlocksFtsCompanion.insert({
    required String id,
    required String content,
    this.rowid = const Value.absent(),
  }) : id = Value(id),
       content = Value(content);
  static Insertable<BlocksFt> custom({
    Expression<String>? id,
    Expression<String>? content,
    Expression<int>? rowid,
  }) {
  ...
  BlocksFtsCompanion copyWith({
    Value<String>? id,
    Value<String>? content,
    Value<int>? rowid,
  }) {
    return BlocksFtsCompanion(
      id: id ?? this.id,
      content: content ?? this.content,
      rowid: rowid ?? this.rowid,
    );
  ...
  @override
  String toString() {
    return (StringBuffer('BlocksFtsCompanion(')
          ..write('id: $id, ')
          ..write('content: $content, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
class NoteFt extends DataClass implements Insertable<NoteFt> {
  final String id;
  final String content;
  const NoteFt({required this.id, required this.content});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<String>(id);
  ...
  NoteFtsCompanion toCompanion(bool nullToAbsent) {
    return NoteFtsCompanion(id: Value(id), content: Value(content));
  }
  ...
  NoteFt copyWith({String? id, String? content}) =>
      NoteFt(id: id ?? this.id, content: content ?? this.content);
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is NoteFt && other.id == this.id && other.content == this.content);
}
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $BlocksFtsTable blocksFts = $BlocksFtsTable(this);
...
typedef $$NoteTagsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool noteId, bool tagId})
    >;
typedef $$BlocksFtsTableCreateCompanionBuilder =
    BlocksFtsCompanion Function({
      required String id,
      required String content,
      Value<int> rowid,
    });
typedef $$BlocksFtsTableUpdateCompanionBuilder =
    BlocksFtsCompanion Function({
      Value<String> id,
      Value<String> content,
      Value<int> rowid,
...
class $$BlocksFtsTableFilterComposer
    extends Composer<_$AppDatabase, $BlocksFtsTable> {
  $$BlocksFtsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BlocksFtsTableOrderingComposer
    extends Composer<_$AppDatabase, $BlocksFtsTable> {
  $$BlocksFtsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BlocksFtsTableAnnotationComposer
    extends Composer<_$AppDatabase, $BlocksFtsTable> {
  $$BlocksFtsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BlocksFtsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $BlocksFtsTable,
          ...
          $$BlocksFtsTableOrderingComposer,
          $$BlocksFtsTableAnnotationComposer,
          $$BlocksFtsTableCreateCompanionBuilder,
          $$BlocksFtsTableUpdateCompanionBuilder,
          (BlocksFt, BaseReferences<_$AppDatabase, $BlocksFtsTable, BlocksFt>),
          BlocksFt,
          PrefetchHooks Function()
        > {
  $$BlocksFtsTableTableManager(_$AppDatabase db, $BlocksFtsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$BlocksFtsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$BlocksFtsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$BlocksFtsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> content = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => BlocksFtsCompanion(id: id, content: content, rowid: rowid),
          createCompanionCallback:
              ({
                required String id,
                required String content,
...
typedef $$BlocksFtsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $BlocksFtsTable,
      BlocksFt,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> content = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => NoteFtsCompanion(id: id, content: content, rowid: rowid),
          createCompanionCallback:
              ({
                required String id,
                required String content,
...
class $AppDatabaseManager {
  ...
  $$BlocksFtsTableTableManager get blocksFts =>
      $$BlocksFtsTableTableManager(_db, _db.blocksFts);
